...
import { Mail, GraduationCap, ArrowLeft, Users, UserCheck, X } from 'lucide-react';
...
const facultyData = [
    { name: 'Dr. Mrs. G. S. Lathkar', role: 'Director', specialization: 'Manufacturing, Design', email: 'lathkar_gs@mgmcen.ac.in', image: '/collegeprofile/Dr. Mrs. G. S. Lathkar.jpg' },
    { name: 'Dr. Jasbeer Singh Sidhu', role: 'Professor', specialization: 'Material Science and Manufacturing', email: 'sidhu_js@mgmcen.ac.in', image: '/collegeprofile/Dr. Jasbeer Singh Sidhu.jpg' },
    { name: 'Sawale Jagannath Khandoji', role: 'Professor', specialization: 'Manufacturing, Design', email: 'sawale_jk@mgmcen.ac.in', image: '/collegeprofile/Sawale Jagannath Khandoji.jpg' },
    { name: 'Kadam Narayan Anandrao', role: 'Assistant Professor', specialization: 'Manufacturing and Automation', email: 'kadam_na@mgmcen.ac.in', image: '/collegeprofile/Kadam Narayan Anandrao.jpg' },
    { name: 'Hatkar Deepak Narayanrao', role: 'Assistant Professor', specialization: 'Heat Power', email: 'hatkar_dn@mgmcen.ac.in', image: '/collegeprofile/Hatkar Deepak Narayanrao.jpg' },
    { name: 'Abdul Rehman MD Iqbal', role: 'Assistant Professor', specialization: 'CADCAMCAE Additive Manufacturing', email: 'rehman_ai@mgmcen.ac.in', image: '/collegeprofile/Abdul Rehman MD Iqbal.jpg' },
    { name: 'Pratap Sitaram More', role: 'Assistant Professor', specialization: 'Renewable Energy(Biogas); ThermalEngineering.', email: 'more_ps@mgmcen.ac.in', image: '/collegeprofile/Pratap Sitaram More.jpg' },
    { name: 'Bandela Chandrashekhar Venkatswamy', role: 'Assistant Professor', specialization: 'Mechanical PLM', email: 'bandela_cv@mgmcen.ac.in', image: '/collegeprofile/Bandela Chandrashekhar Venkatswamy.jpg' },
    { name: 'Pahinkar Prashant Madhukarrao', role: 'Assistant Professor', specialization: 'Thermal Engineering', email: 'pahinkar_pm@mgmcen.ac.in', image: '/collegeprofile/Pahinkar Prashant Madhukarrao.jpg' },
    { name: 'Dr.Prashanth.D.Machkale', role: 'Asst. Professor', specialization: 'Manufacturing Engineering', email: 'machkale_pd@mgmcen.ac.in', image: '/collegeprofile/Dr.Prashanth.D.Machkale.jpg' },
    { name: 'Kamble Vijay Narayanrao', role: 'Assistant Professor', specialization: 'Manufacturing Process Engineering', email: 'kamble_vn@mgmcen.ac.in', image: '/collegeprofile/Kamble Vijay Narayanrao.jpg' },
    { name: 'Darak Akashkumar Rajeshkumar', role: 'Assistant Professor', specialization: 'Manufacturing Process Engineering', email: 'darak_akashkumar@mgmcen.ac.in', image: '/collegeprofile/Darak Akashkumar Rajeshkumar.jpg' },
    { name: 'Shripad Subhashrao Deulkar', role: 'Assistant Professor', specialization: 'Manufacturing Process Engineering', email: 'deulkar_ss@mgmcen.ac.in', image: '/collegeprofile/Shripad Subhashrao Deulkar.jpg' },
    { name: 'Shatalwar Balaji Jagannath', role: 'Assistant Professor', specialization: 'Mechanical CAD/CAM', email: 'balajishatalwar1982@gmail.com', image: '/collegeprofile/Shatalwar Balaji Jagannath.jpg' },
    { name: 'Mr. Chetan P Ramdasi', role: 'Assistant Professor', specialization: 'Manufacturing', email: 'chetanramdasi@gmail.com', image: '/collegeprofile/Mr. Chetan P Ramdasi.jpg' },
];
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 pt-32 pb-20">
                ...
                >
                    ...
                    <h1 className="text-[clamp(32px,5vw,64px)] font-black text-slate-900 leading-[0.9] tracking-tighter mb-4 uppercase">
                        MECHANICAL <br /> <span className="text-primary-600">ENGINEERING.</span>
                    </h1>
                </motion.div>
                ...
                >
                    ...
                    <div className="relative shrink-0">
                        <div className="w-64 h-80 rounded-[2.5rem] overflow-hidden shadow-2xl border-4 border-white relative z-10">
                            <img 
                                src="/collegeprofile/M. G. Harkare.png" 
                                alt="HOD" 
                    ...
                    <div className="flex-1 text-center md:text-left">
                        ...
                        <h2 className="text-4xl font-black text-slate-900 tracking-tight mb-2 italic">Prof. M. G. Harkare</h2>
                        <p className="text-xl font-bold text-slate-500 mb-8 leading-tight">Head, Dept. of Mechanical Engineering</p>
                        
                        <div className="space-y-6 max-w-xl">
                            <p className="text-slate-600 leading-relaxed font-medium">
                                Mechanical Engineering forms the base of all engineering branches. Our department provides excellent infrastructure for UG, PG, and Research activities with advanced labs like HAAS CNC and JANATICS Pneumatics.
                            </p>
                            <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                                <a href="mailto:harkare_mg@mgmcen.ac.in" className="flex items-center justify-center gap-3 px-6 py-4 bg-slate-900 text-white rounded-2xl font-bold hover:bg-primary-600 transition-all shadow-lg group">
                                    <Mail className="w-5 h-5" />
                                    <span>harkare_mg@mgmcen.ac.in</span>
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                >
                    <p className="text-xs font-black text-slate-400 tracking-widest uppercase">Mechanical Engineering | MGM COEN</p>
                            ...
                            <div className="flex-1 p-12 md:p-16 flex flex-col justify-center">
                                ...
                                <div className="space-y-6 mb-12">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-lg font-bold text-slate-400">Mechanical Engineering</p>
                                    </div>
                                </div>
