...
const facultyData = [
    { name: 'Dr. Deepak V. Pattewar', role: 'Professor', specialization: 'Civil Engineering', email: 'pattewar_dv@mgmcen.ac.in', image: '/collegeprofile/Dr. Deepak V. Pattewar.jpg' },
    { name: 'Dr. A. K. Hashmi', role: 'Associate Professor & HOD', specialization: 'Structural Engineering', email: 'hashmi_arshad@mgmcen.ac.in', image: '/collegeprofile/Dr. A. K. Hashmi(civil).jpg' },
    { name: 'Dr. Kalpeshkumar M. Sharma', role: 'Associate Professor', specialization: 'Civil Engineering', email: 'sharma_km@mgmcen.ac.in', image: '/collegeprofile/Dr. Kalpeshkumar M. Sharma.jpg' },
    { name: 'Dr. Mohd. Zameeruddin', role: 'Associate Professor', specialization: 'Structural Engineering', email: 'md_zameeruddin@mgmcen.ac.in', image: '/collegeprofile/Dr. Mohd. Zameeruddin.jpg' },
    { name: 'Mrs. S. V. Kannawar', role: 'Associate Professor', specialization: 'Water Resources Engineering', email: 'kannawar_sv@mgmcen.ac.in', image: '/collegeprofile/Mrs. S. V. Kannawar.jpg' },
    { name: 'Mr. S. D. Halbandge', role: 'Assistant Professor', specialization: 'Structural Engineering', email: 'halbandge_sd@mgmcen.ac.in', image: '/collegeprofile/Mr. S. D. Halbandge.jpg' },
    { name: 'Mr. Girish S. Deshmukh', role: 'Assistant Professor', specialization: 'Structural Engineering', email: 'deshmukh_gs@mgmcen.ac.in', image: '/collegeprofile/Mr. Girish S. Deshmukh.jpg' },
    { name: 'Mr. R. R. Alurwad', role: 'Assistant Professor', specialization: 'Structural Engineering', email: 'alurwad_rr@mgmcen.ac.in', image: '/collegeprofile/Mr. R. R. Alurwad.jpg' },
    { name: 'Mrs. M. P. Kulkarni', role: 'Assistant Professor', specialization: 'Water Resources Engineering', email: 'kulkarni_mp@mgmcen.ac.in', image: '/collegeprofile/Mrs. M. P. Kulkarni.jpg' },
    { name: 'Mr. Rahulkumar R. Sharma', role: 'Assistant Professor', specialization: 'Structural Engineering', email: 'sharma_rr@mgmcen.ac.in', image: '/collegeprofile/Mr. Rahulkumar R. Sharma.jpg' },
    { name: 'Mr. Aniket A.Bhore', role: 'Assistant Professor', specialization: 'Civil Engineering', email: 'aniketbhore@gmail.com', image: '/collegeprofile/Mr. Aniket A.Bhore.jpg' },
    { name: 'Ms. Vaishali I. Kadam', role: 'Assistant Professor', specialization: 'Structural Engineering', email: 'kadam_vaishali@mgmcen.ac.in', image: '/collegeprofile/Ms. Vaishali I. Kadam.jpg' },
    { name: 'Ms. Deshmukh Megha Anandrao', role: 'Assistant Professor', specialization: 'Civil & Water Management', email: 'deshmukh_ma@mgmcen.ac.in', image: '/collegeprofile/Ms. Deshmukh Megha Anandrao.jpg' },
];
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 pt-32 pb-20">
                ...
                >
                    ...
                    <h1 className="text-[clamp(32px,5vw,64px)] font-black text-slate-900 leading-[0.9] tracking-tighter mb-4 uppercase">
                        CIVIL <br /> <span className="text-primary-600">ENGINEERING.</span>
                    </h1>
                </motion.div>
                ...
                >
                    ...
                    <div className="relative shrink-0">
                        <div className="w-64 h-80 rounded-[2.5rem] overflow-hidden shadow-2xl border-4 border-white relative z-10">
                            <img
                                src="/collegeprofile/Dr. A. K. Hashmi(civil).jpg"
                                alt="HOD"
                    ...
                    <div className="flex-1 text-center md:text-left">
                        ...
                        <h2 className="text-4xl font-black text-slate-900 tracking-tight mb-2 italic">Dr. A. K. Hashmi</h2>
                        <p className="text-xl font-bold text-slate-500 mb-8 leading-tight">Head, Dept. of Civil Engineering</p>

                        <div className="space-y-6 max-w-xl">
                            <p className="text-slate-600 leading-relaxed font-medium">
                                This branch of engineering encompasses every facet of civilization, including shelter and water, roads and railways, bridges and tunnels, dams and canals. Established in 1984, the department has well-equipped laboratories with modern tools.
                            </p>
                            <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                                <a href="mailto:hashmi_arshad@mgmcen.ac.in" className="flex items-center justify-center gap-3 px-6 py-4 bg-slate-900 text-white rounded-2xl font-bold hover:bg-primary-600 transition-all shadow-lg group">
                                    <Mail className="w-5 h-5" />
                                    <span>hashmi_arshad@mgmcen.ac.in</span>
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                >
                    <p className="text-xs font-black text-slate-400 tracking-widest uppercase">Civil Engineering | MGM COEN</p>
